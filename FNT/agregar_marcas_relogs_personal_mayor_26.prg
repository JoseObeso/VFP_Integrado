...
cMensage = '...INICIANDO SUBIDA DE MARCAS RELOG DIA 11 EN LA TARDE...' 
_Screen.Scalemode = 0
...
TEXT TO lqry_marcas_relog  noshow
  select codigo, convert(datetime, convert(date, fecha), 101) as fecha,  convert(nvarchar(8), fecha, 108) as  hora, '1' as relog
   from  [BDPERSONAL].[dbo].[ASISTENCIA_02022016]  where FECHA >= CONVERT(datetime, '2018-01-26', 101) + CAST('08:30:24' AS DATETIME)   ORDER BY FECHA 
ENDTEXT
