...
TEXT TO lobtener_items noshow
	  ...
	  INSERT INTO [SIGSALUD].[dbo].[TMP_PRE_ICI]([CLASE],[NOMBRE_CLASE], [ITEM], [SISMED], [NOMBRE], [PRESENTACION], DFECHA_INICIO_PROCESO)
	    select b.CLASE, b.NOMBRE as NOMBRE_CLASE, a.ITEM, interfase2 AS SISMED, UPPER(a.NOMBRE) as nombre, UPPER(PRESENTACION) AS PRESENTACION, GETDATE() AS DFECHA_INICIO_PROCESO from ITEM a 
