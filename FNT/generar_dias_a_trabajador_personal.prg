...
TEXT TO lqry_limpiar_asistencia noshow
      USE BDPERSONAL
	  DELETE FROM asistencia WHERE codigo = ?lccodigo AND mes = ?lmes AND año = ?lanio
ENDTEXT
...
FOR dia  = 1 TO lndias
    ...
    TEXT TO lqry_graba_asistencia noshow
	         INSERT INTO [BDPERSONAL].[dbo].[ASISTENCIA]([CODIGO],[CODACT],[DIA],[MES],[AÑO],[TIPO],[HORAI],[HORAS],[HORA_PRG],[OBSERVACION],[FALTA],[TARDANZA],[PERMISO],[INDICADOR],[SITUACION])
