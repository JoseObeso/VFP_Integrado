...
TEXT TO lqry_ver_cpt noshow
  SELECT [cpt],[descripcion]  FROM [SIGSALUD].[dbo].[cirugia]
ENDTEXT
...
SCAN
 ...
 TEXT TO lqry_ejecuta noshow
   update [SIGSALUD].[dbo].[ITEM] set clasificador = '1.3.3.4.15', GRUPO_LIQUIDACION = '01', GRUPO_RECAUDACION = '01' where codcpt = ?lcodcpt and SUBSTRING(item,1,1) = '6'
 ENDTEXT
 ...
 ELSE
   ...
   TEXT TO lqry_mal noshow
    UPDATE [SIGSALUD].[dbo].[cirugia] SET INDICADOR = 'M' WHERE cpt = ?lcodcpt
   ENDTEXT
