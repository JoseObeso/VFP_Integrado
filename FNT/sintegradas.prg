...
IF FirsTime("sintegradas.exe")  = .t.
   ** Leer del INI
   ...
   IF Archivo_ = .T. 
      ...
      gctitulo = "SISTEMA INTEGRADO DE MONITOREO "
      gndecimal = 0
      gcnombrepc_user_red = SYS(0)
      _screen.Caption = gcsistema + " : " + gctitulo +  "  [FECHA : " + gcfecha + "] " + "  APLICACION : " + gcruta + "   SERVIDOR :   " + UPPER(x_Server)
      _screen.picture=gcgraficos + "fondomonitoreo.jpg"
      _screen.icon=gcgraficos  + "monitoreo.ico"
