...
TEXT TO lqry_limpiar_item noshow
  UPDATE ITEM SET agregar_cpt = ''
ENDTEXT
lejecutabusca = sqlexec(gconecta,lqry_limpiar_item)  
...
TEXT TO lqry_listar_tarifario noshow
   USE SIGSALUD 
   SELECT CODCPT, NOMBRE, PRECIOA, PRECIOSIS, PRECIOSOAT, COMENTARIO  FROM [SIGSALUD].[dbo].[TARIFARIO_ABRIL_2017_V2]
ENDTEXT
