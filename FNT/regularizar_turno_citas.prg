...
lminutos_consulta = 10
	...
	** PARA LAS FECHAS DE DICIEMBRE 
	...
	FOR ltime = 0 TO 30
	    ...
	    cMensage = '...T R A B A J A N D O ---   TURNO MAÑANA ..........., para fecha : ' +lcfechabuscar  + '..... consultorio : ' +lcons
	    _Screen.Scalemode = 0
	    Wait Window cMensage At Int(_Screen.Height/2), Int(_Screen.Width/2 - Len(cMensage)/2) nowait  
	   ...
	   ENDSCAN
	 CLOSE DATABASES ALL
	 cMensage = '...........FIN DE PROCESO TURNO MAÑANA.........., para fecha : ' +lcfechabuscar  + '.... consultorio : ' +lcons
	    _Screen.Scalemode = 0
	    Wait Window cMensage At Int(_Screen.Height/2), Int(_Screen.Width/2 - Len(cMensage)/2) nowait  
