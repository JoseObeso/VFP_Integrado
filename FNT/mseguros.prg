***********************************************************************************************************
********  SISTEMA  INFORMATICO  DE   MONITOREO DE SEGUROS - CONEXION FARMACIA - CUENTAS - EMERGENCIA  ************************
************************************************************************************************************
****************     mseguros    ************************************************************************
...
IF Archivo_ = .T. 
      ...
      gctitulo = "SISTEMA INFORMATICO DE MONITOREO DE SEGUROS - REPORTES"
      gndecimal = 0
      _screen.Caption = gcsistema + " : " + gctitulo +  "  [FECHA : " + gcfecha + "] " + "  APLICACION : " + gcruta + "   SERVIDOR :   " + UPPER(x_Server)
      _screen.picture=gcgraficos + "mseguros.jpg"
      _screen.icon=gcgraficos  + "moniseguros.ico"
